...
std::vector<std::vector<LabyrinthOfLore::WorldMap::Tile>> Construct::build_construct_tile_map_data()
{
...
std::vector<std::vector<LabyrinthOfLore::WorldMap::Tile>> Construct::build_the_underworld_data()
{
float topmost_wall_height = 2.0;
float &t = topmost_wall_height;
float ground_level = 1.0f;
