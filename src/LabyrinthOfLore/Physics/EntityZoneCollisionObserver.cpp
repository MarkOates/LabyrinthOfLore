...
std::vector<std::tuple<LabyrinthOfLore::Entity::Base*, AllegroFlare::vec3d, LabyrinthOfLore::WorldMap::Zone*>> EntityZoneCollisionObserver::get_collisions_at_start()
{
   return collisions_at_start;
}


std::vector<std::tuple<LabyrinthOfLore::Entity::Base*, AllegroFlare::vec3d, LabyrinthOfLore::WorldMap::Zone*>> EntityZoneCollisionObserver::get_collisions_at_end()
{
   return collisions_at_end;
}


std::vector<std::tuple<LabyrinthOfLore::Entity::Base*, AllegroFlare::vec3d, LabyrinthOfLore::WorldMap::Zone*>> EntityZoneCollisionObserver::get_collided(std::vector<LabyrinthOfLore::Entity::Base*> entities, std::vector<LabyrinthOfLore::WorldMap::Zone*> zones)
{
std::vector<std::tuple<LabyrinthOfLore::Entity::Base*, AllegroFlare::vec3d, LabyrinthOfLore::WorldMap::Zone*>> result;
