...
TileMapMeshPillarTexturer::TileMapMeshPillarTexturer(Tileo::TileAtlas* tile_atlas, std::vector<ALLEGRO_VERTEX> cube_vertexes, int tile_index_for_front_and_back_texture, int tile_index_for_right_and_left_texture, int tile_index_for_top_texture)
...
std::vector<ALLEGRO_VERTEX> TileMapMeshPillarTexturer::build_textured_cube(bool scale_for_unit_sized_texture)
{
