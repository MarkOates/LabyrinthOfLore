...
TEST(LabyrinthOfLore_Entity_ThingDictionaryTest,
   create_new_definition__adds_a_new_thing_to_the_dictionary_with_an_id_that_is_at_least_CREATED_THINGS_START)
{
   LabyrinthOfLore::Entity::ThingDictionary thing_dictionary;
   ...
   EXPECT_EQ((int)CREATED_THINGS_START+1, new_id_1);
   EXPECT_EQ((int)CREATED_THINGS_START+2, new_id_2);
   EXPECT_EQ((int)CREATED_THINGS_START+3, new_id_3);
}
