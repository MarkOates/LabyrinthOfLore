...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, load__throws_an_exception_if_there_is_a_nullptr_source_bitmap)
{
   ALLEGRO_BITMAP *source_bitmap = nullptr;

   LabyrinthOfLore::WorldMap::MultiBitmapTileMapLoader bitmap_tile_map_loader(source_bitmap);
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, pick_index_I_color__returns_the_expected_value)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, pick_index_G_color__returns_the_expected_higher_elevation_colors)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, pick_index_G_color__returns_the_expected_lower_elevation_colors)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, infer_tile_map_width__returns_the_final_width_of_the__tile_map__which_should_be_2_less_than_the_source_bitmap_width)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, infer_tile_map_height__returns_the_final_height_of_the__tile_map__which_should_be_equal_to_the_source_bitmap_height)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, load__returns_a_tile_map_with_the_expected_width_and_height)
{
   al_init();
   al_init_image_addon();
   ...
   LabyrinthOfLore::WorldMap::MultiBitmapTileMapLoader loader(source_bitmap);
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, colors_are_equal__returns_true_if_colors_are_the_same__and_false_if_they_are_different)
{
   al_init();
   al_init_image_addon();

   LabyrinthOfLore::WorldMap::MultiBitmapTileMapLoader loader(nullptr);
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, load__correctly_picks_out_top_tiles)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, load__correctly_picks_out_ground_tiles)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, load__correctly_picks_out_ascending_elevation_tiles)
{
   al_init();
   al_init_image_addon();
...
TEST(LabyrinthOfLore_WorldMap_MultiBitmapTileMapLoaderTest, load__correctly_picks_out_descending_elevation_tiles)
{
   al_init();
   al_init_image_addon();
