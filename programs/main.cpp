...
public:
   ...
   void initialize()
   {
      cube_model.load_obj_file("bin/programs/data/models/unit_cube-01.obj", 1.0);
      cube_texture = al_load_bitmap("bin/programs/data/bitmaps/unit_cube-01b.png");
   }
   ...
   if (active)
   {
      ...
      while(!shutdown_program)
      {
         ...
         case ALLEGRO_EVENT_TIMER:
            {
               camera_entity->get_velocity_ref().position = {-0.005, -0.05, 0};
